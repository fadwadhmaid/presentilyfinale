<template>
    <AdminLayout title="Modifier l'offre">
        <div class="mb-6">
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 text-white">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h2 class="text-2xl font-bold">Modifier l'offre</h2>
                        <p class="text-blue-100 mt-1">Modifiez les informations de l'offre</p>
                    </div>
...
export default {
    ...
    setup(props) {
        ...
        const features = typeof props.offer.features === 'string' 
            ? JSON.parse(props.offer.features) 
            : (props.offer.features || { presentations: 0, simulations: 0, reformulations: 0 });
        ...
        const form = useForm({
            ...
            features: {
                presentations: features.presentations || 0,
                simulations: features.simulations || 0,
                reformulations: features.reformulations || 0
            },
